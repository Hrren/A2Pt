...
from data.imagenet_a import get_imagenet_a_datasets
from data.imagenet_sketch import get_imagenet_sketch_datasets
from data.imagenet_v2 import get_imagenet_v2_datasets
...
get_dataset_funcs = {
    ...
    'imagenet_a': get_imagenet_a_datasets,
    'imagenet_sketch': get_imagenet_sketch_datasets,
    'imagenet_v2': get_imagenet_v2_datasets
}
...
def get_class_splits(dataset, split_idx=0, cifar_plus_n=10):
    ...
    if dataset in ('cifar-10-10', 'mnist', 'svhn'):
        ...
        #open_set_classes = None

    elif dataset == 'imagenet-a' or 'imagenet-r' or 'imagenet_sketch' or 'imagenet_v2':
        train_classes = []
        for i in range(200):
