...
from config import imagenet_sketch_val
...
class TinyImageNet(torchvision.datasets.ImageFolder):
    ...
    def __getitem__(self, item):
        ...
        img, label, index, oath = super().__getitem__(item)
...
def get_imagenet_sketch_datasets(train_transform, test_transform, train_classes=range(20),
    ...
    test_dataset_known = TinyImageNet(root=imagenet_sketch_val, transform=test_transform)
